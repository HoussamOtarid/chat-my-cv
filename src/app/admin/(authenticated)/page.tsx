        ...
        <div className='space-y-6'>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Configure your language model provider and settings</CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                        <Label htmlFor='api-key'>{selectedProvider?.apiKeyLabel || 'API Key'}</Label>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Customize the chat interface and user experience</CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                    <div className='space-y-2'>
